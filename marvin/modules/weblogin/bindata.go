...
func layoutHtmlTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "layout.html", size: 2121, mode: os.FileMode(420), modTime: time.Unix(1481242895, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"layout.html": &bintree{layoutHtmlTmpl, map[string]*bintree{}},
